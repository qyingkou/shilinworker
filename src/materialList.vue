<template>
  <div class="g-page">
      ...
      <div class="m-setting">
        <div class="m-setting__header">
          <h3 class="ttl1">
            设置
            <i
              class="u-iconfont u-icon-arrow-up"
              @click="setPanel = false"
              v-show="setPanel"
            ></i>
            <i
              class="u-iconfont u-icon-arrow-down"
              @click="setPanel = true"
              v-show="!setPanel"
            ></i>
          </h3>
        </div>
        <div class="m-setting__bodyer" v-show="setPanel">
              ...
              <div class="m-form__item">
                ...
                <div class="m-form__itemcnt">
                  <label>
                    ...
                    <input class="u-ipt" type="text" v-model="page.padding" />
                  </label>
                </div>
              </div>
            </div>
              ...
              <div class="m-form__item">
                ...
                <div class="m-form__itemcnt">
                  <label>
                    ...
                    <input class="u-ipt" type="text" v-model="materials.cols" />
                  </label>
                  <label>
            ...
            <div class="m-form__section">
              ...
              <div class="m-form__item">
                ...
                <div class="m-form__itemcnt">
                  <label>
                    <span class="u-lab">每行列数</span>
                    <input class="u-ipt" type="text" v-model="results.cols" />
                  </label>
                  <label>
                    <span class="u-lab">水平间距(px)</span>
                    <input
    ...
    <div class="g-page__bodyer">
      <div
        class="m-canvas z-edit"
        id="canvas"
        :style="{ height: page.height + 'px', padding: page.padding + 'px' }"
      >
        <p class="u-corner u-corner-page">
          文档宽度{{ page.width }}px * 高度{{ page.height }}px（A4比例纸张横向）
        </p>
        ...
        <div class="m-canvas__area m-canvas__material">
          <p class="u-corner u-corner-material">
            <span>图片区域1</span>
            <i
              class="u-iconfont u-icon-wenjianjia"
              @click="doFilesSelect('materials')"
            ></i>
          </p>
          <ul class="m-imageList">
            <li
              v-for="(item, index) in materials.list"
            ...
            >
              <div class="m-imageList__cell">
                ...
                <i
                  class="u-iconfont u-icon-closeb"
        ...
        <div class="m-canvas__area m-canvas__result">
          ...
          <ul class="m-imageList">
            <li
              v-for="(item, index) in results.list"
    ...
    <div class="g-page__footer">
      <div class="g-page__footerSubmit">
        <button class="u-btn u-btn-genarate" @click="generate">生成图片</button>
      </div>
